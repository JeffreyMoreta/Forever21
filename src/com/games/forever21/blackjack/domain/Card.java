 ...
 */
enum Card {
    ONE_DIAMONDS(1),   TWO_DIAMONDS(2),  THREE_DIAMONDS(3), FOUR_DIAMONDS(4),
    ONE_CLUBS(1),      TWO_CLUBS(2),     THREE_CLUBS(3),    FOUR_CLUBS(4),
    ONE_HEARTS(1),     TWO_HEARTS(2),    THREE_HEARTS(3),   FOUR_HEARTS(4),
    ONE_SPADES(1),     TWO_SPADES(2),    THREE_SPADES(3),   FOUR_SPADES(4),
    ...
    KING_SPADES(10),   ACE_SPADES(11),
    KING_DIAMONDS(10), ACE_DIAMONDS(11),
    KING_CLUBS(10),    ACE_CLUBS(11),
    KING_HEARTS(10),   ACE_HEARTS(11);
